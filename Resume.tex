...
\begin{itemize}
  ...
  \item Research (Fall 2016): Setting up a Hadoop cluster for the analysis of rosbags (ROS) with \textit{C++} jobs
\end{itemize}
...
\begin{itemize}
  ...
  \item As a result, enabled launching native Android TV apps (YouTube, Netflix) from a query to Google Home
\end{itemize}
...
\begin{itemize}
  ...
  \item Achieved 70\% of correct classification for simple hand gestures (machine learning, signal processing)
