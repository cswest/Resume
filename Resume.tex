...
\styledesc{Software Engineer II -- Google Cloud Platform, Persistent Storage} \hfill \styledates{Aug. 2018}\\
\vspace{\margincontent}
\begin{itemize}
  \item Working on a block device over the network for virtual machines in GCP (\textit{C++})
  \item Enabling write-through caching to improve efficiency of read-modify-write requests for Cloud SQL
  \item Maintaining an internal fork of the device for data-intensive tasks on Borg
\end{itemize}
