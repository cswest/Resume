...
\noindent\begin{tabular}{@{}p{7.15cm}p{12cm}}
  ...
  \textbf{Other:} \LaTeX, \textit{Matlab}, \textit{Asm}, \textit{Vim}, \textit{tmux}, \textit{bash} & \textbf{Web:} \textit{HTML}/\textit{CSS}, \textit{SQL}, \textit{Angular.js}, \textit{Node.js}, \textit{D3.js}, \textit{Bootstrap}\\
