...
\styledesc{Software Engineer Intern, Google Assistant} \hfill \styledates{Jan. 2017 -- Apr. 2017}\\
\vspace{\margincontent}
\begin{itemize}
  \item Working on Assistant Server, the \textit{C++} backend for Google Assistant, and on the client-side in \textit{Java}.
\end{itemize}
...
I practice badminton, hiking and personal development: last year I switched to \textit{Vim}, learned touch typing, and totally quit drinking sodas. This year I am getting into running, I will keep on traveling out of France and learning more about science and algorithms.
